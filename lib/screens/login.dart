...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void registerUser() async{
    ...
    var url ="https://finalprojmobprog.000webhostapp.com/login_flutter/signup.php";
    var data = {
  ...
  void userSignIn() async{
    ...
    var url ="https://finalprojmobprog.000webhostapp.com/login_flutter/signin.php";
    var data = {
      "email":emailctrl.text,
      "pass":passctrl.text,
    };
    ...
    if(jsonDecode(res.body) == "account not existing"){
